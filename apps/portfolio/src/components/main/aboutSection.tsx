...
export default function AboutSection() {
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center bg-white dark:bg-black text-black dark:text-white py-24 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            ...
            >
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-sm text-black/50 dark:text-white/50 hover:text-black transition-colors group"
              >
                Learn more
