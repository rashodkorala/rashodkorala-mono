...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-ink/20 bg-cream/80 text-ink/70 backdrop-blur transition hover:bg-cream dark:border-[#2f2c2a] dark:bg-[#151312] dark:text-[#d0cbc5] dark:hover:bg-[#1a1817]"
    >
