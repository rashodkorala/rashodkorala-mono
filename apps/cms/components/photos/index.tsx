...
import { IconDotsVertical, IconEdit, IconPhoto, IconPlus, IconRefresh, IconStar, IconTrash, IconTrendingUp } from "@tabler/icons-react"
...
const Photos = ({ initialPhotos }: PhotosProps) => {
    ...
    // Sync state when initialPhotos changes (after refresh)
    useEffect(() => {
